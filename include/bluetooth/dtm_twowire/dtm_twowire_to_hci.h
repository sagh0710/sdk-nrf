...
typedef enum {
  /* Returned when a two-wire event was generated */
...
/** @brief Process a DTM two-wire command and generate either a two-wire event or an HCI command.
 *
 *  @note CTE and antenna switching features are not currently supported by this library.
 *
 *  @param[in] tw_cmd     Two-wire command to process.
 *  @param[out] hci_cmd   Buffer for the generated HCI command (allocated by caller), if any.
 *  @param[out] tw_event  Pointer to the generated two-wire event, if any.
 *
 *  @return Status of the processing result.
 *  @retval DTM_TW_TO_HCI_STATUS_TW_EVENT A two-wire event was generated and stored in @p tw_event .
 *  @retval DTM_TW_TO_HCI_STATUS_HCI_CMD  An HCI command was generated and stored in @p hci_cmd .
 *  @retval DTM_TW_TO_HCI_STATUS_ERROR    An error was encountered during processing. No output was generated.
 */
dtm_tw_to_hci_status_t dtm_tw_to_hci_process_tw_cmd(const uint16_t tw_cmd, struct net_buf *hci_cmd, uint16_t *tw_event);

/** @brief Process an HCI event and generate a DTM two-wire event.
 *
 *  @param[in] tw_cmd       Two-wire command that the caller is expecting a response to.
 *  @param[in] hci_event    HCI event to process.
 *  @param[out] tw_event    Pointer to the generated two-wire event, if any.
 *
 *  @return Status of the processing result.
 *  @retval DTM_TW_TO_HCI_STATUS_TW_EVENT   A two-wire event was generated and stored in @p tw_event .
 *  @retval DTM_TW_TO_HCI_STATUS_UNHANDLED  The HCI event was irrelevant to DTM. No output was generated.
 *  @retval DTM_TW_TO_HCI_STATUS_ERROR      An error was encountered during processing. No output was generated.
 */
